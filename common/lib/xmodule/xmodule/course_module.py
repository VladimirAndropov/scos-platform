...
class CourseFields(object):
    ...
    competences = String(
        display_name=_("Competences"),
        help=_(
            "Enter the competences in the course."
            "number and name."
        ),
        scope=Scope.settings
    )
    ...
    assessment_description = String(
        display_name=_("assessment_description"),
        help=_(
            "Enter the assessment_description in the course."
            "If you dont know what is it, enter  null."
        ),
        scope=Scope.settings
    )
    
    accreditated = String(
        display_name=_("accreditated"),
        help=_(
            "Enter the accreditated in the course."
            "If you dont know what is it, enter  null."
        ),
        scope=Scope.settings
    )
    ...
    proctoring_type = String(
        display_name=_("proctoring_type"),
        help=_(
            "Enter the proctoring_type in the course."
            "If you dont know what is it, enter  null."
        ),
        scope=Scope.settings  
    )
    ...
    proctoring_service = String(
        display_name=_("proctoring_service"),
        help=_(
            "Enter the proctoring_service in the course."
            "If you dont know what is it, enter  null."
        ),
        scope=Scope.settings,
        default="Examus"
    ...
    estimation_tools = String(
        display_name=_("estimation_tools"),
        help=_(
            "Enter the estimation_tools in the course."
            "If you dont know what is it, enter  null."
        ),
        scope=Scope.settings
    )
    ...
    hours = Integer(
        display_name=_("hours"),
        help=_(
            "Enter the hours in the course."
            "If you dont know what is it, enter  40+."
        ),
        scope=Scope.settings,
        default="40"
    )
    ...
    hours_per_week = Integer(
        display_name=_("hours_per_week"),
        help=_(
            "Enter the hours_per_week in the course."
            "If you dont know what is it, enter from 7 to 40"
        ),
        scope=Scope.settings,
        default="7"
    )
    ...
    requirements = String(
        display_name=_("requirements"),
        help=_(
            "Enter the requirements in the course."
            "If you dont know what is it, enter  null."
        ),
        scope=Scope.settings
    )
    ...
    duration = Integer(
        ...
        help=_(
            "Enter the duration in the course."
            "If you dont know what is it, enter  0"
        ),
        scope=Scope.settings
    )
    
    business_version = Integer(
        display_name=_("business_version"),
        help=_(
            "Enter the business_version in the course."
            "If you dont know what is it, enter  0"
        ),
        scope=Scope.settings
    )
