...
def _update_context_with_basic_info(context, course_id, platform_name, configuration):
    ...
    context['certificate_verify_urltext'] = _("0")
...
def _update_context_with_user_info(context, user, user_certificate):
    ...
    if str(user_certificate.grade) is not "":
        context['certificate_verify_urltext'] = "{:.0f}".format(100*float(user_certificate.grade)) 
