...
@ensure_valid_course_key
@cache_if_anonymous()
def course_advanced(request, course_id):
    """
    Display the course's advanced page.
    """
    course_key = CourseKey.from_string(course_id)
    ...
    with modulestore().bulk_operations(course_key):
        ...
        return render_to_response('courseware/course_advanced.html', context)
...
def course_about(request, course_id):
    ...
    with modulestore().bulk_operations(course_key):
        ...
        if  certificates_enabled_for_course:
              cert = "True"
        else:
              cert = None     
