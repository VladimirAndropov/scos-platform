...
from  lms.djangoapps.instructor_task.tasks_helper.utils import tracker_emit, upload_csv_to_report_store
...
def upload_students_csv(_xmodule_instance_args, _entry_id, course_id, task_input, action_name):
    ...
    query_features = [
      ...
      course_key_string = 'course-v1:fa_ifg+topfinadvice+2022'
    """
    start_time = time()
    start_date = datetime.now(UTC)
