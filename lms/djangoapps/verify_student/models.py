...
# class SoftwareSecurePhotoVerification(IDVerificationAttempt):
#     """
#     Each ManualVerification represents a user's verification that bypasses the need for
#     any other verification.
#     """
...
#     reviewing_service = models.CharField(blank=True, max_length=255, default="")
#     error_msg = models.TextField(blank=True, default="")
#     error_code = models.CharField(blank=True, max_length=50, default="")
...
#     copy_id_photo_from = models.ForeignKey(
#         User,
#         default=True,null=True, blank=True, on_delete=models.CASCADE,
#         related_name="id_verifications_reviewed",
#     )
...
class SoftwareSecurePhotoVerification(PhotoVerification):
    ...
    def upload_photo_id_image(self, img_data):
        ...
        if settings.FEATURES.get('AUTOMATIC_VERIFY_STUDENT_IDENTITY_FOR_TESTING'):
            ...
            self.reviewing_user = User.objects.get(username='localboss')
            self.save()
            return
    ...
    @status_before_must_be("must_retry", "ready", "submitted","approved")
