...
MARKETING_SITE_ROOT = os.environ.get('MARKETING_SITE_ROOT', 'http://project2820634.tilda.ws/')
...
#    CORS_ORIGIN_ALLOW_ALL = ENV_TOKENS.get('CORS_ORIGIN_ALLOW_ALL', False)
    ...
    CORS_ORIGIN_WHITELIST = ('https://ecommerce.online.fa.ru',)
...
MAX_FAILED_LOGIN_ATTEMPTS_ALLOWED = ENV_TOKENS.get("MAX_FAILED_LOGIN_ATTEMPTS_ALLOWED", 50)
MAX_FAILED_LOGIN_ATTEMPTS_LOCKOUT_PERIOD_SECS = ENV_TOKENS.get("MAX_FAILED_LOGIN_ATTEMPTS_LOCKOUT_PERIOD_SECS", 1 * 60)
...
SOCIAL_AUTH_SCOS_SECRET = '2c886229-dca2-420e-9585-606e245029f9'
...
###################### JWTs ######################
JWT_AUTH.update({
    'JWT_ISSUER': 'https://online.fa.ru/oauth2',
    'JWT_AUDIENCE': 'lms-keyfaonline',
    'JWT_SECRET_KEY': 'lms-secretfaonline',
...
LANGUAGE_MAP = {'terms': {lang: display for lang, display in ALL_LANGUAGES}, 'name': 'Язык'}
COURSE_DISCOVERY_MEANINGS = {
    ...
    'modes': {
        'name': 'Цена',
        'terms': {
            'honor': 'веб-сертификат',
            'verified': 'с прокторингом',
            'credit': 'В кредит',
            'professional': 'Бумажный сертификат',
            'audit': 'Бесплатный курс',
        },
    },
...
EXAMUS_SAMESITE_ALLOW_ALL = True
