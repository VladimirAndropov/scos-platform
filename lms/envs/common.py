...
OAUTH_OIDC_ISSUER = 'https:/online.fa.ru/oauth2'
...
GRADES_DOWNLOAD = {
    ...
    'BUCKET': 'edx-grades',
    'ROOT_PATH': '/mnt/yandex.disk/grades',
}
...
MAX_FAILED_LOGIN_ATTEMPTS_ALLOWED = 2
MAX_FAILED_LOGIN_ATTEMPTS_LOCKOUT_PERIOD_SECS = 1 * 60
...
DEFAULT_JWT_ISSUER = {
    'ISSUER': 'https://online.fa.ru/oauth2',
    'SECRET_KEY': 'lms-keyfaonline',
    'AUDIENCE': 'lms-keyfaonline',
}

RESTRICTED_APPLICATION_JWT_ISSUER = {
    'ISSUER': 'https://online.fa.ru/oauth2',
    'SECRET_KEY': 'lms-secretfaonline',
    'AUDIENCE': 'lms-keyfaonline',
}
