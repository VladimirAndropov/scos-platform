...
class CourseOverview(TimeStampedModel):
    ...
    #SCOS
    competences = TextField(default='')
    assessment_description = TextField(default='')
    accreditated = TextField(default='')
    proctoring_type = TextField(default='')
    proctoring_service = TextField(default='')
    estimation_tools = TextField(default='')
    hours = IntegerField(default=40)
    hours_per_week = IntegerField(default=7)
    requirements = TextField(default='')
    duration = IntegerField(default=1)
    business_version = IntegerField(default=1)
    ...
    def _create_or_update(cls, course):
        ...
        course_overview.competences = course.competences
        course_overview.assessment_description = course.assessment_description
        course_overview.accreditated = course.accreditated
        course_overview.proctoring_type = course.proctoring_type
        course_overview.proctoring_service = course.proctoring_service
        course_overview.estimation_tools = course.estimation_tools
        course_overview.hours = course.hours
        course_overview.hours_per_week = course.hours_per_week
        course_overview.requirements = course.requirements
        course_overview.duration = course.duration
        course_overview.business_version = course.business_version
        # course_overview.discussion_topics = course.discussion_topics
